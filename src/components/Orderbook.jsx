...
//     const alignedBidPrice = Number((Math.round(bidPrice / tickSize) * tickSize).toFixed(3));
//     const alignedAskPrice = Number((Math.round(askPrice / tickSize) * tickSize).toFixed(3));
...
//     const offset = Number(((((strike % 100) || 100) + typeMultiplier) * tickSize * 0.01).toFixed(3)); // Smaller offset
...
//               bidPrice: newOrderBooks[strike]?.bidPrice || (strike > 0 ? strike * 0.05 : 100),
//               askPrice: newOrderBooks[strike]?.askPrice || (strike > 0 ? strike * 0.05 + 0.05 : 100.05)
//             };
//           }
...
//                   Number((price * 0.999).toFixed(3)), // Fixed typo (was 999)
//                   qty,
//                   id,
//                   index
//                 ]),
...
//             if (
//               Math.abs(price % tickSize) < 1e-12 && // Higher tolerance
