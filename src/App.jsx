...
//     const roundedBidPrice = Number((Math.round(parsedBidPrice / tickSize) * tickSize).toFixed(2));
//     const roundedAskPrice = Number((Math.round(parsedAskPrice / tickSize) * tickSize).toFixed(2));
